...
//! Example qCC plugin
/** Replace 'qCalculateVerticality' by your own plugin class name throughout and then
	check 'qCalculateVerticality.cpp' for more directions.
...
**/
class qCalculateVerticality : public QObject, public ccStdPluginInterface
{
	Q_OBJECT
	...
	Q_PLUGIN_METADATA( IID "cccorp.cloudcompare.plugin.qCalculateVerticality" FILE "../info.json" )

public:
	explicit qCalculateVerticality( QObject *parent = nullptr );
	~qCalculateVerticality() override = default;
...
protected slots:
	void doActionCalculateVerticality();
	void doActionSliceExtration();
...
private:
	...
	**/
	QAction* actionCalculateVerticality;
	QAction* actionSliceExtration;
